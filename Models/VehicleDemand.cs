...
namespace Week2.CarManager.Models
{
    public class VehicleDemand
    {
        ...
        public VehicleDemand(string driverFirstName, string driverLastName, string destinatioLocation, DateTime departureTime, DateTime returnTime, string purpose, string disponentFirstName, string disponentLastName, string disponentPhone, Vehicle vehicle = null)
        {
